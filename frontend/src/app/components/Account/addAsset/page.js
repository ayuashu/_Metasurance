...
const AddAsset = () => {
    ...
    const [tokenValue, setTokenValue] = useState(""); // [TODO
    ...
    useEffect(() => {
        const handletokenValue = async () => {
            try {
                const response = await fetch(`${HOST}/api/user/gettokenvalue`, {
                    method: 'GET',
                    credentials: 'include',
                });
                    ...
                    <div className="col-span-2 ..." >
                        ...
                        <div className="flex-1 pt-10 h-auto max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                            <div className="flex flex-col md:flex-row">
                                <div className="hidden h-32 md:h-auto md:w-1/2 md:flex md:items-center md:justify-center">
                                ...
                                <div className="flex items-center justify-center sm:p-12 md:w-1/2">
                                    <div className="w-full">
                                        ...
                                        <div className="px-5 md:px-0">
                                            <label className="block mt-2 text-sm">Asset Value (in tokens)( 1 token = ₹{tokenValue})</label>
                                            <input type="number"
                                                className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                                                value={assetValue}
                                        ...
                                        <button onClick={(e) => handleLogin(e)}
                                            className="block w-full py-2 mt-4 text-sm font-medium  text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">
                                            Register
                                        </button>


                                        <hr className="my-2 px-5 md:px-0" />

                                        <div className="flex items-center justify-center gap-4 px-5 md:px-0">
