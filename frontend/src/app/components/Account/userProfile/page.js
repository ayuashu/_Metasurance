      ...
      <div className="bg-slate-700 bg-blend-lighten hover:bg-blend-darken min-h-screen">
        ...
        <div className="grid grid-cols-3 gap-4 min-h-screen px-10 py-10">
          <div className="..." style={{ height: '70vh' }}>
            <div className="w-full max-w-sm min-h-full bg-white border border-gray-200 rounded-lg shadow ">
              <div className="flex flex-col items-center pb-10 pt-20">
                ...
                {userDataLoaded ? (
                  <>
                    <h5 className="mb-1 text-xl font-medium text-gray-900">Hello, {name}</h5>
                    <h3 className="mb-1 text-xl font-medium text-gray-800">Email: {email}</h3>
                    <h3 className="mb-1 text-xl font-medium text-gray-800">Mobile: {phone}</h3>
                  </>
                ) : (
              ...
              <div className="flex items-center justify-center">
                <button
                  onClick={() => navigate('/components/Account/userProfile/Services')}
                  className="h-10 px-11 text-indigo-100 text-lg transition-colors duration-150 bg-slate-700 rounded-full focus:shadow-outline hover:bg-slate-900">
                  <b>Services</b>
                </button>
              </div>
              ...
              <div className="flex items-center justify-center pt-5">
                <button
                  ...
                  className="h-10 px-11 text-indigo-100 text-lg transition-colors duration-150 bg-slate-700 rounded-full focus:shadow-outline hover-bg-slate-900">
                  <b>{viewPolicies ? 'View Assets' : 'View Policies'}</b>
                </button>
              </div>
          ...
          <div className="col-span-2 ... bar" style={{ border: "2px solid white", height: '70vh', overflow: 'auto' }}>
            {viewPolicies ? <PolicyCard /> : <AssetCard userName={username}/>}
          </div>
        </div>
        <Footer />
      </div>
