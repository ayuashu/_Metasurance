        ...
        <div className="grid grid-cols-3 gap-4 min-h-screen px-10 py-10">
          ...
          <div className="col-span-2 ...">
            ...
            <div className='grid grid-cols-2 gap-20 pt-20'>
              <div className='profile-box' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <ProfileAnimation />
              </div>
              <div className='profile-box' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '80px'}}>
                <ProfileAnimation1 />
              </div>
            </div>
