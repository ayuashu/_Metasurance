...
const VerifierRegister = () => {
    ...
    const handleVeriferRegistration = async (e) => {
        e.preventDefault()
        ...
        let url = `${HOST}/api/verifier/register`
        let body = {
            username,
            name,
            email,
        ...
        if (response.status === 200) {
            ...
            navigate("/components/Account/verifierProfile/")
        } else {
            alert(json.error);
        }
    }
                            ...
                            <div className="flex flex-col md:flex-row">
                                ...
                                <div className="flex items-center justify-center p-2 sm:p-12 md:w-1/2">
                                    <div className="w-full">
                                        ...
                                        <button onClick={(e) => handleVeriferRegistration(e)}
                                        ...
                                        <div className="flex items-center justify-center gap-4">
                                            <button onClick={() => navigate('/components/Account/verifierRegistration')}
