...
const Page = () => {
  ...
  return (
    <>
      <div className="bg-slate-900 bg-blend-lighten hover:bg-blend-darken min-h-screen">
        <Navigation />
        <div className="boxcontainer mx-auto p-4 flex flex-row flex-wrap" style={{ height: '90vh' }}>
          ...
          <div className='basis-1/3 flex flex-col w-full pr-5'>
            ...
            <div className="p-10 mt-auto w-full">
              <div className='px-20'>
                <img
                  ...
                  alt="Image"
                  className='rounded-xl shadow-xl hover:scale-110'
