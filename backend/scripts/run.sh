...
docker exec -it cli bash ./scripts/install-cc/install-onpeer-cc.sh policy_cc peer0 insurer InsurerMSP 7051 2.5 # install in common channel now
docker exec -it cli bash ./scripts/install-cc/install-onpeer-cc.sh policy_cc peer0 user UserMSP 8051 2.5
echo "Instantiating policy_cc"
docker exec -it cli bash ./scripts/install-cc/instantiate.sh policy_cc peer0 insurer InsurerMSP 7051 2.5
docker exec -it cli bash ./scripts/install-cc/instantiate.sh policy_cc peer0 user UserMSP 8051 2.5
