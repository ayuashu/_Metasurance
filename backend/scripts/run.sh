...
docker exec -it cli bash ./scripts/channel/join-peer.sh peer0 assets AssetsMSP 9051 1.0
docker exec -it cli bash ./scripts/channel/join-peer.sh peer0 exampleadmin MetaAdminMSP 10051 1.0
