...
sleep 20
peer channel create -o orderer0.metasurance.com:7050 -c $CHANNEL_NAME -f ./channel-artifacts/commonChannel.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA >&log.txt
